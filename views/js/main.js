...
var pizzaElementGenerator = function(i) {
  ...
  pizzaContainer.classList.add("pizza-medium"); // Default size
...
// Cache pizza containers and moving pizzas globally
var pizzaContainers;
var movingPizzas;

// resizePizzas(size) is called when the slider in the "Our Pizzas" section of the website moves.
var resizePizzas = debounce(function(size) {
  ...
  // Changes pizza sizes by switching CSS classes
  function changePizzaSizes(size) {
    var newClass;
    switch(size) {
      case "1":
        newClass = "pizza-small";
        break;
      case "2":
        newClass = "pizza-medium";
        break;
      case "3":
        newClass = "pizza-large";
        break;
      default:
    ...
    for (var i = 0; i < pizzaContainers.length; i++) {
      pizzaContainers[i].classList.remove("pizza-small", "pizza-medium", "pizza-large");
      pizzaContainers[i].classList.add(newClass);
    }
  }
...
// Cache pizza containers after generation
...
// Cache phase values for efficiency
var phaseCache = new Array(5);
...
function updatePositions() {
  ...
  // Precompute phase values for the 5 groups
  for (var i = 0; i < 5; i++) {
...
// runs updatePositions on scroll with debounce
var debouncedUpdatePositions = debounce(function() {
  requestAnimationFrame(updatePositions);
}, 16); // ~60 FPS
