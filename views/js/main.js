...
1. Fixed resizePizzas() - removed layout thrashing
2. Fixed updatePositions() - optimized calculations and use transform
3. Reduced number of animated pizzas to what's actually visible
...
// Pizza ingredients arrays remain the same
...
// Name generator - no changes needed
String.prototype.capitalize = function () {
  return this.charAt(0).toUpperCase() + this.slice(1);
};

// getAdj and getNoun functions remain the same
function getAdj(x) {
  switch (x) {
    case "dark":
...
// Pizza name and ingredient generators - no changes needed
...
// OPTIMIZED: resizePizzas function - Major performance fix #1
var resizePizzas = function (size) {
  ...
  // OPTIMIZATION: Simplified approach - directly set percentage widths
  function changePizzaSizes(size) {
    ...
    // Get all pizza containers once
    var pizzas = document.querySelectorAll(".randomPizzaContainer");
    // Set new width for all pizzas
...
// OPTIMIZED: Generate fewer background pizzas - only what's visible
